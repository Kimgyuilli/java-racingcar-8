...
1. 미션은 자동차 경주 저장소를 포크하고 클론하는 것으로 시작한다.
2. 기능을 구현하기 전 README.md에 구현할 기능 목록을 정리해 추가한다.
3. Git의 커밋 단위는 앞 단계에서 README.md에 정리한 기능 목록 단위로 추가한다.
4. AngularJS Git Commit Message Conventions을 참고해 커밋 메시지를 작성한다.
5. 자세한 과제 진행 방법은 프리코스 진행 가이드 문서를 참고한다.
...
5. 테스트 도구 사용법이 익숙하지 않다면 아래 문서를 참고하여 학습한 후 테스트를 구현한다.
      JUnit 5 User Guide
      AssertJ User Guide
